...
def get_args_parser():
    parser = argparse.ArgumentParser('Set parameters for training M2PLNet', add_help=False)
    ...
    parser.add_argument('--data_root', default=f'F:\ShanghaiTech_Crowd_Counting_Dataset\part_A_final\\',
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('M2PLNet training and evaluation script', parents=[get_args_parser()])
